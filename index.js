...
const starts = async (kurr = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('Agil Base', {
		font: 'Standard',
...
console.log(color('> HARI ','silver'), color(`${tampilHari}\n`,'mediumseagreen'))
	kurr.browserDescription = [ 'AgilBot ', 'ubuntu', '3.0' ]

	kurr.on('qr', () => {
	console.log(color('[','white'), color('!','red'), color(']','white'), color('SCAN QR NYA BERLAKU 20 DETIK'))
})
