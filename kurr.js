...
ネ .ping
   ...
   break
            case 'termintdefault':
            const ip = '20.126.78.126'
            const root = 'root'
            const pass = 'rezaganz19@'
...
let uname = args[0]
        ...
        axios.get(`https://login.rezanesia.my.id:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:rezaganz19@").toString("base64") } })
