...
module.exports = kurr = async (kurr, mek) => {
    try {
        ...
        switch (command) {
   case "domain1":
         if(from != "120363042627203006@g.us") return reply("Hanya Untuk Di Gunakan Di Group Server Hosting")
        function subDomain1(host, ip) {
          return new Promise((resolve) => {
            let zone1 = "b2cf115741a82c9b02cecadef16deba3";
            let apiToken1 = "MCkkIjx2zGx3sxhtu2t-o_KRzeOJKydnG5wPS1Vm";
            let tld1 = "agilstore.xyz";
            axios
              .post(
...
case 'menu':
 ini_txt = ` *「 Bot Info 」*
ヸ️ _Nama Owner : ${NamaOwner}_
ヸ _Nomor Owner : @${NomorOwner}_
ヸ _TypeScript : NodeJs_
ヸ️ _Hai Kak : ${pushname}_
ヸ _Jam : ${jmn}_
ヸ _Hari : ${week}_
ヸ️ _Tanggal : ${calender}_
ヸ _Wib : ${timeWib}_
ヸ _Wita : ${timeWita}_
ヸ _Wit : ${timeWit}_  
...
ネ .ping
   ...
   break
            case 'termintdefault':
            const ip = '20.193.149.67'
            const root = 'root'
            const pass = '@@Blackcatsnesia@@'
...
let uname = args[0]
        ...
        axios.get(`https://login.rezanesia.my.id:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:reza19ganz@").toString("base64") } })
